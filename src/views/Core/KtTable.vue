<template>
  <div>
    ...
    <div class="toolbar" style="padding:10px;">
      ...
      <!--</el-pagination>-->
<!--自定义选择每页显示页数-->
      <el-pagination @current-change="refreshPageRequest"   @size-change="sizeChange"  :current-page.sync="pageRequest.pageNum" :page-sizes="[10, 20, 50, 100]" :page-size="pageRequest.pageSize" layout="sizes, prev, pager, next,jumper" :total="data.totalSize" style="float:right;">
      </el-pagination>
